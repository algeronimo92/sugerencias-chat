...
crear_usuario() {
  ...
  # Sin tags: ninguno de los dos entra a la consola de administración.
  rabbitmqctl set_user_tags "$usuario"
}
...
# Evolution API: publica y nada más. El `read` vacío es lo que importa — si esta
# credencial se filtra, no alcanza para leer una sola conversación.
#
