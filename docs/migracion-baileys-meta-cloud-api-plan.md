...
nunca produce `@lid`, así que `parse_message_identity` simplemente no
...
2. **Ventana de 24 h — ✅ HECHO, con un rediseño respecto a lo planteado
   ...
   `_raise_if_send_rejected()` valida la _forma_ de la respuesta (un envío
