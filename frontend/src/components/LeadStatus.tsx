const STATUS_COLORS: Record<string, string> = {
  nuevo: 'bg-wa-field dark:bg-wa-head-dark text-gray-700 dark:text-gray-300',
  ...
  cliente_activo: 'bg-green-100 dark:bg-green-950/50 text-green-800 dark:text-wa-primary',
  ...
  baja: 'bg-wa-border dark:bg-wa-active-dark text-gray-600 dark:text-wa-muted-dark',
}

const CONFIANZA_COLORS: Record<string, string> = {
  alta: 'bg-green-100 dark:bg-green-950/50 text-wa-primary-strong dark:text-wa-primary',
...
export function LeadStatus({ estado, confianza }: Props) {
  const estadoColor = STATUS_COLORS[estado.toLowerCase()] ?? 'bg-wa-field dark:bg-wa-head-dark text-gray-700 dark:text-gray-300'
  const confianzaColor = CONFIANZA_COLORS[confianza.toLowerCase()] ?? 'bg-wa-field dark:bg-wa-head-dark text-gray-700 dark:text-gray-300'
