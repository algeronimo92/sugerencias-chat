...
export function SaveAsTemplateDialog({ content, onClose }: { content: string; onClose: () => void }) {
  ...
  function submit(event: React.FormEvent) {
    ...
    create.mutate({ name: name.trim(), content, shortcut: shortcut.trim() || null }, {
      onSuccess: onClose,
